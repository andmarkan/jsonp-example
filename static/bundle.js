...
},{"backbone":10,"collections/photos":2,"views/layout":7}],2:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":10,"backbone.attributes":9,"underscore":12}],3:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<input name="user" value="'+
((__t=( this.collection.getAttribute('user') ))==null?'':__t)+
'"><select name="endpoint"><option value="stream">Stream</option>';
 if (this.collection.getAttribute('endpoint')==='faves') { 
__p+='<option value="faves" selected="selected">';
 } else { 
__p+='<option value="faves">';
 } 
__p+='Faves</option></option></select><button>Fetch!</button><p>#photos: <span>'+
((__t=( this.collection.size() ))==null?'':__t)+
'</span></p><p>Note: You can find a Twitter user ID <a href="http://idgettr.com/">here</a></p>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<section id="controls"></section><section id="photos"></section>';
}
return __p;
};
...
((__t=( p.link ))==null?'':__t)+
'"><img src="'+
((__t=( p.media.m ))==null?'':__t)+
'"></a><p>'+
((__t=( p.author ))==null?'':__t)+
'</p>'+
((__t=( Date.parse(p.date_taken).toLocaleString() ))==null?'':__t)+
''+
((__t=( Date.parse(p.published).toLocaleString() ))==null?'':__t)+
'';
 if (p.tags) { 
__p+='<h3>tags</h3>'+
((__t=( p.tags ))==null?'':__t)+
...
},{"backbone":10,"templates/controls.jst":3}],7:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":10,"templates/layout.jst":4,"views/controls":6,"views/photos":8}],8:[function(require,module,exports){
var Backbone = require('backbone');
